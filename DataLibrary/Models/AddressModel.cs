...
namespace DataLibrary.Models
{
    public class AddressModel
    {
		...
		[RequiredIf("GroundRentPaymentFrequency == AddressModel.PaymentFrequency.SemiAnnual && NotLegibleType != AddressModel.InputType.PaymentDateSemiAnnual1", ErrorMessage = "A Semi-Annual date selection must be made.")]
		[DataType(DataType.DateTime)] public DateTime? PaymentDateSemiAnnual1 { get; set; }
		[RequiredIf("GroundRentPaymentFrequency == AddressModel.PaymentFrequency.SemiAnnual && NotLegibleType != AddressModel.InputType.PaymentDateSemiAnnual2", ErrorMessage = "A Semi-Annual date selection must be made.")]
		[DataType(DataType.DateTime)] public DateTime? PaymentDateSemiAnnual2 { get; set; }
		[RequiredIf("GroundRentPaymentFrequency == AddressModel.PaymentFrequency.Quarterly && NotLegibleType != AddressModel.InputType.PaymentDateQuarterly1", ErrorMessage = "A Quarterly date selection must be made.")]
		[DataType(DataType.DateTime)] public DateTime? PaymentDateQuarterly1 { get; set; }
		[RequiredIf("GroundRentPaymentFrequency == AddressModel.PaymentFrequency.Quarterly && NotLegibleType != AddressModel.InputType.PaymentDateQuarterly2", ErrorMessage = "A Quarterly date selection must be made.")]
		[DataType(DataType.DateTime)] public DateTime? PaymentDateQuarterly2 { get; set; }
		[RequiredIf("GroundRentPaymentFrequency == AddressModel.PaymentFrequency.Quarterly && NotLegibleType != AddressModel.InputType.PaymentDateQuarterly3", ErrorMessage = "A Quarterly date selection must be made.")]
