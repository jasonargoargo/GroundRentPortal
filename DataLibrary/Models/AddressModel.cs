...
namespace DataLibrary.Models
{
    public class AddressModel
    {
        ...
        [DataType(DataType.Date)] public DateTime? PaymentDateSemiAnnual2 { get; set; }
        [DataType(DataType.Date)] public DateTime? PaymentDateQuarterly1 { get; set; }
        [DataType(DataType.Date)] public DateTime? PaymentDateQuarterly2 { get; set; }
        [DataType(DataType.Date)] public DateTime? PaymentDateQuarterly3 { get; set; }
        [DataType(DataType.Date)] public DateTime? PaymentDateQuarterly4 { get; set; }
        [MaxLength(128)]public string? PaymentDateOther { get; set; }
